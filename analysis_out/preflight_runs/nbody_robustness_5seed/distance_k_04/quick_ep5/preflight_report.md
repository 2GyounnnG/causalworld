...
Created: `2026-05-01T20:44:31.471080+00:00`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| none | 0.3603 +/- 0.1478 (n=5) | 1.1553 +/- 0.7845 (n=5) | 0.100000 +/- 0.000000 (n=5) | 0.100000 +/- 0.000000 (n=5) | 0.000000 +/- 0.000000 (n=5) | 0.0000 +/- 0.0000 (n=5) | 0.000000 +/- 0.000000 (n=5) | 0.000463 +/- 0.000246 (n=5) |
| graph | 0.2660 +/- 0.1270 (n=5) | 1.0176 +/- 0.7199 (n=5) | 0.100000 +/- 0.000000 (n=5) | 0.100000 +/- 0.000000 (n=5) | 0.291952 +/- 0.044293 (n=5) | 0.1561 +/- 0.0256 (n=5) | 0.015612 +/- 0.002560 (n=5) | 0.005209 +/- 0.000900 (n=5) |
| permuted_graph | 0.2660 +/- 0.1338 (n=5) | 1.0604 +/- 0.8055 (n=5) | 0.100000 +/- 0.000000 (n=5) | 0.028981 +/- 0.008324 (n=5) | 1.048783 +/- 0.204297 (n=5) | 0.3926 +/- 0.0698 (n=5) | 0.011269 +/- 0.003429 (n=5) | 0.003611 +/- 0.001043 (n=5) |
| temporal_smooth | 0.2747 +/- 0.1278 (n=5) | 1.0624 +/- 0.7224 (n=5) | 0.100000 +/- 0.000000 (n=5) | 3643.829503 +/- 559.197945 (n=5) | 0.000008 +/- 0.000002 (n=5) | 0.0000 +/- 0.0000 (n=5) | 0.010375 +/- 0.001743 (n=5) | 0.004645 +/- 0.001345 (n=5) |

Graph gain vs none at H=32: `+11.9%`
...
| --- | --- | --- | --- | --- |
| graph | 1.4421 +/- 0.0716 (n=5) | 0.0936 +/- 0.0077 (n=5) | 0.1553 +/- 0.0077 (n=5) | 0.3384 +/- 0.0176 (n=5) |
| permuted_graph | 1.7276 +/- 0.0946 (n=5) | 0.0770 +/- 0.0154 (n=5) | 0.1374 +/- 0.0167 (n=5) | 0.2739 +/- 0.0285 (n=5) |

Paired `D_true_norm(permuted - graph)`: `0.2855 +/- 0.0617 (n=5)`
Graph lower latent-energy count: `5/5`

## Latent-Energy Correlation

Pearson r between `D_true_norm(Delta_H)` and H=32 rollout over audited runs: `0.0853`
...
H=32 temporal_smooth rollout: `1.0624`; temporal gain vs none: `+8.0%`; graph gain vs temporal_smooth: `+4.2%`.
...
- `analysis_out/preflight_runs/nbody_robustness_5seed/distance_k_04/quick_ep5/summary.csv`
- latent artifacts under `analysis_out/preflight_runs/nbody_robustness_5seed/distance_k_04/quick_ep5/artifacts`
