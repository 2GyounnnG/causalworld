...
EXPERIMENT_NAME = "rmd17_multimolecule_disjoint_checkpointed"
MOLECULES = ["ethanol", "malonaldehyde"]
ENCODER = "flat"
PRIORS = ["none", "euclidean", "spectral"]
SEEDS = [0, 1, 2, 3, 4]
NUM_EPOCHS = 50
HORIZONS = [1, 2, 4, 8, 16]
OUTPUT_PATH = ROOT / "rmd17_multimolecule_disjoint_checkpointed.json"
CHECKPOINT_DIR = "checkpoints/rmd17_multimolecule_disjoint_checkpointed"
AGGREGATE_PATH = ROOT / "analysis_out/aggregate_rmd17_multimolecule_disjoint_checkpointed.csv"
REPORT_PATH = ROOT / "analysis_out/RMD17_MULTIMOLECULE_DISJOINT_CHECKPOINTED.md"
...
def refresh_analysis() -> None:
    analyze_file(
        ...
        title="rMD17 Multimolecule Disjoint Checkpointed",
        expected_molecules=MOLECULES,
